...
<div class="right">
	...
	<div class="search">
		<form method="post" action="${pageContext.request.contextPath }/user/userList">
			...
			<input type="hidden" name="pageIndex" value="1" /> <input value="查 询" type="submit" id="searchbutton">
	...
	<c:import url="../common/rollpage.jsp">
		<c:param name="totalCount" value="${userList.total}" />
		<c:param name="currentPageNo" value="${userList.pageNum}" />
		<c:param name="totalPageCount" value="${userList.pages}" />
	</c:import>
</div>
</section>

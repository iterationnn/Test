...
<body>
	...
	<header class="publicHeader">
		...
		<div class="publicHeaderR">
			<p>
				<span>下午好！</span><span style="color: #fff21b"> ${userSession.userName }</span> , 欢迎你！
			</p>
			<a href="${pageContext.request.contextPath }/sys/doLogout">退出</a>
		</div>
	</header>
	<!--时间-->
		...
		<div class="left">
			...
			<nav>
				<ul class="list">
					...
					<li><a href="${pageContext.request.contextPath }/sys/doLogout">退出系统</a></li>
				</ul>
			</nav>
		</div>
